...
namespace cryptonote
{
  ...
  bool get_block_hash(const block& b, crypto::hash& res)
  {
    ...
    if (BLOCK_MAJOR_VERSION_2 == b.major_version || BLOCK_MAJOR_VERSION_3 == b.major_version || BLOCK_MAJOR_VERSION_4 == b.major_version)
    {
  ...
  //---------------------------------------------------------------
  bool check_proof_of_work_v3(const block& bl, difficulty_type current_diffic, crypto::hash& proof_of_work)
  {
  ...
  bool check_proof_of_work(const block& bl, difficulty_type current_diffic, crypto::hash& proof_of_work)
  {
    ...
    case BLOCK_MAJOR_VERSION_4: return check_proof_of_work_v3(bl, current_diffic, proof_of_work);
